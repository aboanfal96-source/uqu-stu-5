...
function exportPDF(){
  ...
  var allSlides='';
  slides.forEach(function(s){allSlides+='<div class="sp">'+s.html+'</div>';});
  var win=window.open('','_blank');
  if(!win){alert('يرجى السماح بالنوافذ المنبثقة');return;}
  win.document.write('<!DOCTYPE html><html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>'+projName+'</title>'+
    ...
    'body{margin:0;padding:0;font-family:Cairo,Arial,sans-serif;direction:rtl}'+
    ':root{--teal:#0d7a7a;--gold:#c9a227;--gl:#e8c94a;--r:12px}'+
    '.sp{page-break-after:always;break-after:page;width:100%;overflow:hidden}'+
    '.sp:last-child{page-break-after:avoid}'+
    '.cv{background:linear-gradient(160deg,#0d5c5c,#052f2f)!important;min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:50px 40px;position:relative}'+
    '.cv-univ-ar{font-size:20px;font-weight:900;color:#fff}.cv-univ-en{font-size:10px;color:rgba(255,255,255,.45);letter-spacing:2px}'+
    '.cv-dept1{font-size:12px;color:rgba(255,255,255,.7);font-weight:600}.cv-dept2{font-size:11px;color:rgba(255,255,255,.45)}'+
    '.cv-logo-box{background:rgba(255,255,255,.95);border-radius:14px;padding:14px 20px;display:flex;align-items:center;justify-content:center}'+
    '.cv-logo-box img{max-height:60px;width:auto}.cv-header{display:flex;align-items:center;justify-content:center;margin-bottom:28px;width:100%;max-width:700px}'+
    '.cv-hdr-div{width:1px;height:72px;background:rgba(201,162,39,.35);margin:0 22px}.cv-univ-block{text-align:right;flex:1}'+
    ...
    '.cv-five-text{font-size:16px;font-weight:700;color:#e8c94a;letter-spacing:2px}'+
    '.cv-proj-name{font-size:24px;font-weight:900;color:#fff;line-height:1.6;max-width:680px;margin:0 auto 14px}'+
    '.cv-yr-line{font-size:13px;color:rgba(255,255,255,.4)}.cv-bar{position:absolute;bottom:0;left:0;right:0;height:5px;background:linear-gradient(90deg,#0d7a7a,#c9a227,#0d7a7a)}'+
    ...
    '.si-n{font-size:68px;font-weight:900;color:rgba(201,162,39,.1);line-height:1}.si h2{font-size:36px;font-weight:900;color:#e8c94a}'+
    '.si-desc{font-size:13px;color:rgba(255,255,255,.4);margin-top:12px;text-align:center;max-width:400px;line-height:1.8}'+
    ...
    '.cs-hdr{background:linear-gradient(135deg,#0d7a7a,#085f5f)!important;padding:14px 26px;display:flex;align-items:center;justify-content:space-between}'+
    '.cs-hdr-l{display:flex;align-items:center;gap:12px}.cs-hdr-dv{width:1px;height:26px;background:rgba(255,255,255,.2)}'+
    '.cs-hdr h3{font-size:15px;font-weight:800;color:#fff}.cs-bdg{background:rgba(201,162,39,.2);border:1px solid rgba(201,162,39,.4);border-radius:5px;padding:3px 10px;font-size:10px;font-weight:700;color:#e8c94a}'+
    '.cs-body{padding:20px 26px;color:#1a1a1a;direction:rtl;font-size:13px;line-height:1.75}'+
    '.cs-body h4{font-size:13px;font-weight:800;color:#085f5f;border-right:3px solid #c9a227;padding-right:9px;margin:16px 0 8px}'+
    ...
    '.cs-body ul li{font-size:12.5px;line-height:1.7;color:#555;display:flex;align-items:flex-start;gap:7px;padding:6px 11px;background:rgba(13,122,122,.04)!important;border-radius:7px;border-right:2px solid rgba(13,122,122,.15)}'+
    '.cs-body ul li::before{content:"◈";color:#0d7a7a;font-size:9px;flex-shrink:0;margin-top:4px}'+
    '.hbox{background:rgba(13,122,122,.07)!important;border:1px solid rgba(13,122,122,.14);border-radius:9px;padding:12px 14px;margin:8px 0;font-size:12.5px;line-height:1.8;color:#222}'+
    '.hbox.gld{background:rgba(201,162,39,.08)!important;border-color:rgba(201,162,39,.2)}'+
    '.tcols{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px}'+
    '.icard{background:rgba(13,122,122,.06)!important;border:1px solid rgba(13,122,122,.12);border-radius:8px;padding:10px 12px}'+
    '.ct{font-size:10px;font-weight:700;color:#085f5f;margin-bottom:4px}'+
    '.cs-body table{width:100%;border-collapse:collapse;font-size:12px;margin-top:6px}'+
    '.cs-body th{background:#0d7a7a!important;color:#fff;padding:8px 11px;text-align:right;font-weight:700;font-size:11px}'+
    '.cs-body td{padding:7px 11px;border-bottom:1px solid rgba(0,0,0,.05);color:#333;vertical-align:top}'+
    ...
    '.rh{background:rgba(220,50,50,.1)!important;color:#c03030}.rm{background:rgba(200,130,0,.1)!important;color:#c07020}.rl{background:rgba(30,160,80,.1)!important;color:#1a7040}'+
    '.recbad{color:#1a7040;font-weight:700}'+
    ...
    '.tl-box{background:rgba(13,122,122,.04)!important;border:1px solid rgba(13,122,122,.1);border-radius:7px;padding:8px 11px;flex:1;margin-bottom:3px}'+
    '.tl-box .pt{font-size:12px;font-weight:700;color:#085f5f}.tl-box .pm{font-size:11px;color:#888;margin-top:2px}.tl-box .pd{font-size:11.5px;color:#555;margin-top:3px}'+
    '.cs-ftr{background:rgba(13,122,122,.04)!important;border-top:1px solid rgba(13,122,122,.08);padding:6px 26px;display:flex;align-items:center;justify-content:space-between}'+
    '.cs-ftr span{font-size:10px;color:#888}.cs-fbar{height:4px;background:linear-gradient(90deg,#0d7a7a,#c9a227)}'+
    '@page{size:A4;margin:0}</style></head><body>');
  win.document.write(allSlides);
  win.document.write('</body></html>');
  win.document.close();
  win.onload=function(){win.focus();win.print();setTimeout(function(){win.close();},3000);};
}
function exportWord(){
  ...
  try{
    ...
    var body='<div style="background:#0d5c5c;color:#fff;padding:40px;text-align:center"><div style="font-size:22px;font-weight:900;color:#e8c94a;margin-bottom:10px">تقرير الدراسات الخمسة</div><div style="font-size:16px;font-weight:900">'+projName+'</div><div style="font-size:11px;opacity:.7;margin-top:6px">'+projMeta+'</div></div>';
    slides.forEach(function(s){
      if(s.t==='cover')return;
      var tmp=document.createElement('div');tmp.innerHTML=s.html;
      if(s.t==='sec'){var h2=tmp.querySelector('h2');if(h2)body+='<div style="background:#085f5f;color:#e8c94a;padding:18px 24px;margin-top:18px;page-break-before:always"><strong style="font-size:18px">'+h2.textContent+'</strong></div>';return;}
      var hdr=tmp.querySelector('.cs-hdr h3');var bdg=tmp.querySelector('.cs-bdg');var bd=tmp.querySelector('.cs-body');
      if(bd){body+='<div style="margin:12px 0;border:1px solid #dde;border-radius:6px;overflow:hidden"><div style="background:#0d7a7a;color:#fff;padding:10px 14px;display:flex;justify-content:space-between"><strong>'+(hdr?hdr.textContent:'')+'</strong><span style="font-size:10px;opacity:.8">'+(bdg?bdg.textContent:'')+'</span></div><div style="padding:14px;direction:rtl;font-size:10.5pt;line-height:1.8">'+bd.innerHTML.replace(/class="[^"]*"/g,'').replace(/style="direction:ltr;/g,'style="')+'</div></div>';}
    });
    var html='<!DOCTYPE html><html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>'+projName+'</title><style>body{font-family:Arial,sans-serif;direction:rtl;margin:1.5cm;font-size:10.5pt;line-height:1.8;color:#111}table{width:100%;border-collapse:collapse;margin:8px 0;font-size:10pt}th{background:#0d7a7a!important;color:#fff!important;padding:7px 10px;text-align:right;-webkit-print-color-adjust:exact;print-color-adjust:exact}td{padding:6px 10px;border:1px solid #ddd;vertical-align:top}tr:nth-child(even) td{background:#f5fafa!important;-webkit-print-color-adjust:exact;print-color-adjust:exact}ul{list-style:none;padding:0;margin:6px 0}li{padding:5px 10px;margin:3px 0;background:#f0f8f8!important;border-right:3px solid #0d7a7a;-webkit-print-color-adjust:exact;print-color-adjust:exact}h4{color:#085f5f;border-right:3px solid #c9a227;padding-right:8px;margin:12px 0 5px;font-size:10.5pt}@page{size:A4;margin:1.5cm}</style></head><body>'+body+'</body></html>';
    var win=window.open('','_blank','width=960,height=720');
    if(!win){alert('يرجى السماح بالنوافذ المنبثقة');btn.disabled=false;btn.textContent='📄 تحميل وورد';return;}
    win.document.write(html);win.document.close();win.focus();
    btn.textContent='✅ جاهز — اضغط Ctrl+P ثم احفظ PDF أو Ctrl+S للوورد';
    setTimeout(function(){btn.textContent='📄 تحميل وورد';},6000);
